...
if (isset($_REQUEST['email'])) {
    ...
    $mail->Username   = 'learn2001@gmail.com';                     //SMTP username
    $mail->Password   = 'Imperial1@@@';                               //SMTP password
    $mail->SMTPSecure = "tls";            //Enable implicit TLS encryption
    $mail->Port       = 587;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

    //Recipients
    $mail->setFrom('daspapidas8@gmail.com', 'Imperial College');
    ...
    <div class="container">
        <div class="col-md-12">
            <form action="" method="POST">
                ...
                <!-- <?php if(isset($img_pdf)): ?>
                    <br><br>
                    <a href="<?php echo $img_pdf; ?>" class="btn btn-primary text-light fw-bolder" download>Download Certificates</a>
                <?php endif; ?> -->
            </form>
            <br>
        </div>
